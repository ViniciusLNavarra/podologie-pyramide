...
function Footer() {
  return (
    <footer class="text-center bg-gray-100 text-gray-600">
      <div class="mx-6 py-10 text-left lg:text-center">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
          ...
          <div class="">
            ...
            <p class="flex items-center justify-center md:justify-start mb-4">
              ...
              Lärchenstrasse 10, 8953 Dietikon
            </p>
            <p class="flex items-center justify-center md:justify-start mb-4">
      ...
      <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-gray-600 font-semibold" href="https://viniciusnavarra.ch/">Podologie Pyramide</a>
      </div>
    </footer>
  )
}
