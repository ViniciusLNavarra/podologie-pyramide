<div class="w-[65vw] m-auto mt-[3vh]">
  ...
  <h2 class={subtitle}>Der diabetische Fuss</h2>
  <p class="font-oswald">
  ...
  <h2 class={subtitle}>Hyperkeratosen</h2>
  <p class="font-oswald">
  ...
  <h2 class={subtitle}>Die Warze</h2>
  <p class="font-oswald">
  ...
  <h2 class={subtitle}>Dermatosis juvenilis plantaris</h2>
  <p class="font-oswald">
    Bricht bei präpubertären Kindern aus. Sichtbar sind Erytheme, Hyperkeratosen und 
    Fissuren. Oft ist die Grosszehe betroffen und Zonen mit grosser Reibung. Die Haut 
    ist rot, glänzend, trocken und wie ein Papyrus. Sie entwickelt sich normalerweise 
    innerhalb von zwei Wochen. Fovorisierende Faktoren sind Fussschwitzen und 
    synthetische Strümpfe und Schuh.
  </p>
  <h2 class={subtitle}>Subguale Clavus</h2>
  <p class="font-oswald">
    Vermehrte Hornhautbildung unter dem Nagel. Am häufigsten bildet er sich am distalen 
    Rand des Grosszehennagels durch ständiges Anstossen der Zehe am Schuh während dem
    Gehen.
  </p>
  <h2 class={subtitle}>Halux Valgus</h2>
  <p class="font-oswald">
    Der Halux Valgus ist die Abweichung des ersten Mittelfussknochens (Metatarsus) zur 
    Körpermitte hin mit gleichzeitiger Verschiebung der Grosszehe zur Fussmitte hin 
    (Valgusstellung). Ursachen dafür können entweder intrinsische Faktoren sein wie 
    genetische Vorbelastung oder anatomische Anomalien der Muskeln, Knochen, Sehnen 
    oder extrinsische Faktoren wie Schuhe, Trauma, Unfälle, usw. Die Vorausstellung des 
    ersten Metatarsus verursacht oft eine Exostose am Metatarsusköpfchen und die 
    Luxation der Sesambeine, während die Grosszehe in Pronation und Valgusstellung 
    übergeht.
  </p>
  <h2 class={subtitle}>Hammerzehe</h2>
  <p class="font-oswald">
    Ist eine Veränderung der Zehenstellung, bei der eine oder mehrere Phalangen der 
    Zehen nach plantar gebeugt werden. Meistens betrifft das die mittleren Zehen und 
    wenn die zweite Zehe länger als die Grosszehe ist. Die Hammerzehe hat oft ihren 
    Ursprung in der Jugendzeit durch falsches Schuhwerk (nicht passende or zu kleine 
    Schuhe). Durch die krumme Zehenstellung entsteht Apikal und dorsal ein ständiger
    Kontakt mit dem Schuh und verursacht dort schmerzende Hyperkeratosen anfangs ist die
    Veränderung meistens schmerzfrei, wird aber mit fortschreitender Veränderung vor 
    allem im Grosszehengrundgelenk immer schmerzhafter.
  </p>
  <h2 class={subtitle}>Schuheinlagen</h2>
  <p class="font-oswald">
    Die Einlagen sind ein medizinisches, auf Mass gefertigtes Produkt. Sie haben auf 
    mehreren Ebenen eine wichtige Funktion: Sie sollen korrigieren und/oder kompensieren 
    und sie sollen die Lebensqualität verbessern. Auf Mass gefertigte Einlagen, um 
    solche zu sein, sind nur die Person bestimmt, für die Einlagen gefertigt wurden da 
    jeder von uns anatomisch, altersmässig, gewichtsmässig und durch seine Pathologien 
    unterschiedlich ist.
  </p>
  <h2 class={subtitle}>Silikonorthesen</h2>
  <p class="font-oswald">
    Silikonorthesen sind die geeignetestn Mittel um Konfliktzonen der Zehen und deren 
    axialen Abweichungen zu vermeiden bzw. zu verbessern. Auf Mass gefertigt, können sie 
    zur Verbesserung der axialen Position der deformierten Zehen wie Hammerzehen oder 
    Halux Valgus uns somit zur besser entgegenwircken. Gleichermassen können sie als 
    Schutz für schmerzende Zonen verursacht d
  </p>
  <h1 class={title}>Dystrophischen Nagelbehandlung</h1>
  <h2 class={subtitle}>Dystrophe und deformierte Nägel</h2>
  <p class="font-oswald">
  ...
  <h2 class={subtitle}>Nagelprothese/ Teilnagelprothese</h2>
  <p class="font-oswald">
    Die Nagel- oder Teilnagelprothese dient als Ersatz oder für den Aufbau eines Nagels.
    Sie schützt das Nagelbett und dient dem nachwachsenden Nagel angepasst. Der Nagel 
    wird vorgängig behandelt, dünner geschliffen und in Form gebracht.
  </p>
  <h2 class={subtitle}>Fusspflege/ Pedikür</h2>
  <p class="font-oswald">
    Fussbflege/ Pedikür ist die präventive, therapeutische und rehabilitative Behandlung 
    am gesunden, von Schädigungen bedrohten oder bereits geschädigten Fuss. Unsere 
    Pediküre in unserem Praxis in Zürich umfasst zu Beginn eine wohltuende 
    Fussbehandlung. Hier kann sich bereits die Hornhaut lösen und die Nagelhäutchen 
    werden zurückgeschoben. Auch die Nägel lassen sich nach der entspannten Fussbehandlung 
    leicht schneiden und splittern nicht. Abschliessend werden die Füsse eingecremt und 
    leicht massiert.
  </p>
  <h1 class={title}>Orthonexie</h1>
  <h2 class={subtitle}>Schuheinlagen</h2>
  <p class="font-oswald">
    Die Einlagen sind ein medizinische, auf Mass gefertigtes Produkt. Sie haben auf 
    mehreren Ebenen eine wichtige Funktion: Sie korrigieren und/oder kompensieren und 
    sie sollen die Lebensqualität verbessern. Auf Mass gefetigte Einlagen, um solche zu 
    sein, sind nur für die Person bestimmt, für die die Einlagen gefetigt wurden da jeder 
    von uns anatomisch, altersmässig, gewichtsmässig und durch seine Pathologien 
    unterschiedlich ist. (Interdisziplinär, bei Orthoschritt zussammenarbeiten)
  </p>
  <h2 class={subtitle}>Silikonorthesen</h2>
  <p class="font-oswald">
    Silikonorthesen sind mit die geeignetesten Mittel um Konfliktzonen der Zehen und 
    deren axialen Abweichungen zu vermeiden bzw. zu verbessern. Auf Mass gefertigt, 
    können sie zur Verbesserung der axialen Position der deformierten Zehen wie 
    Hammerzehen oder Halux Valgus und somit zur besseren Funktion derselben beitragen 
    bzw. einem Fortschreiten der axialen Deviation entgegenwirken. Gleichermassen können 
    sie als Schutz für schmerzende Zonen verursacht durch Reibung und Reibung und Druck, 
    wie am Grosszehengrundgelenk beim Halux Valgus, Wunden, usw eingesetzt werden.
  </p>
  <h1 class={title}>Fuss und Unterschenkelmassage</h1>
  <h2 class={subtitle}>Fussreflexzonenmassagen</h2>
  <p class="font-oswald">
    ...
    Fussreflexzonenmassage wird der gesamte Fuss massiert. Verspürt der Patient an 
    bestimmten Stellen Schmerzen, ist das ein Hinweis auf Störungen in den dazugehörigen 
    Organen. Durch wiederholtes Massieren der schmerzhaften Fusszonen werden diese 
    Störungen in den dazugehörigen Organen. Durch wiederholtes Massieren der 
    schmerzhaften Fusszonen werden diese Störungen gelindert oder gar behoben.
  </p>
  <h2 class={subtitle}>Detox Fussmassage</h2>
  <p class="font-oswald">
    Mit Zugabe einer heissen Öl-Mischung wird der ganze Fuss intensiv massiert. Dabei 
    dring das Öl in das Gewebe ein und Giftstoffe und Schlacken werden gelöst. Ist die 
